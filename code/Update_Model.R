...
spearman2 = spearman2(log1p(Degree) ~ Repository_Forks_Count + Today_UpDate_Months +  Update_Create_Months + Repository_Size + Versions_Count + Dependent_Projects_Count + Dependent_Repositories_Count, data = model_data, p = 2)
plot(spearman2)

fit <- ols(log1p(Degree) ~ rcs(Dependent_Repositories_Count,5) + rcs(Today_UpDate_Months,3) +  Repository_Forks_Count , data = model_data, x = T, y = T )
fit
...
spearman2 = spearman2(log1p(Degree) ~ Today_UpDate_Months +  Update_Create_Months + Repository_Size + Versions_Count + Dependent_Projects_Count + Dependent_Repositories_Count, data = model_data, p = 2)
plot(spearman2)

fit <- ols(log1p(Degree) ~ rcs(Dependent_Projects_Count ,5) + rcs(Today_UpDate_Months,3) + Repository_Size , data = model_data, x = T, y = T )
fit
...
reject_vars <- c('Repository_Forks_Count','Dependent_Repositories_Count' )
ind_vars <- ind_vars[!(ind_vars%in% reject_vars)]
vc <- varclus(~ ., data = model_data[, ind_vars], trans='abs')
plot(vc)
threashold <- 0.7
...
spearman2 = spearman2(log1p(Degree) ~ Today_UpDate_Months +  Update_Create_Months + Repository_Size + Versions_Count + Dependent_Projects_Count + Repository_Contributors_Count , data = model_data, p = 2)
plot(spearman2)

fit <- ols(log1p(Degree) ~ rcs(Dependent_Projects_Count,5) + rcs(Today_UpDate_Months,3) +  Update_Create_Months, data = model_data, x = T, y = T )
fit
...
spearman2 = spearman2(log1p(Degree) ~ Today_UpDate_Months +  Update_Create_Months + Repository_Size + Versions_Count + Dependent_Projects_Count +Versions_Count +  Repository_Contributors_Count , data = model_data, p = 2)
plot(spearman2)

fit <- ols(log1p(Degree) ~ rcs(Dependent_Projects_Count,5) + rcs(Versions_Count,3) + Today_UpDate_Months, data = model_data, x = T, y = T )
fit
